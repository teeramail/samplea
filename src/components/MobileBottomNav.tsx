...
export default function MobileBottomNav() {
  ...
  const handleChatClick = () => {
    ...
    // If Tawk_API is not loaded yet, try to maximize the chat
    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white shadow-lg border-t border-gray-200 md:hidden">
      <div className="flex h-16">
        ...
        <button
          ...
          className="flex flex-1 items-center justify-center bg-blue-600 text-white transition-colors hover:bg-blue-700 active:bg-blue-800"
        >
          <div className="flex flex-col items-center space-y-1">
