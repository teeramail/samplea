...
async function seedVenues() {
  try {
    ...
    if (existingTypes.length > 0) {
      console.log(
        `Found ${existingTypes.length} existing venue types. Skipping venue type creation.`,
      );
    } else {
      // Create venue types
      const venueTypeData = [
        {
          ...
          name: "Muay Thai",
          description:
            "Traditional Thai boxing gyms offering authentic Muay Thai training",
        },
        {
          id: "vtype_kickboxing",
          name: "Kickboxing",
          description:
            "Gyms specializing in kickboxing techniques and training",
        },
        {
          id: "vtype_mma",
          name: "MMA",
    ...
    if (existingRegions.length > 0 && existingRegions[0]?.id) {
      ...
      console.log(
        `Using existing region: ${existingRegions[0].name ?? "Unknown"}`,
      );
    } else {
    ...
    if (existingVenues.length > 0) {
      console.log(
        `Found ${existingVenues.length} existing venues. Skipping venue creation.`,
      );
    } else {
      // Sample venue data
      const venueData = [
        {
          ...
          capacity: 100,
          thumbnailUrl:
            "https://images.unsplash.com/photo-1517438476312-10d79c077509?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8bXVheSUyMHRoYWl8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60",
          isFeatured: true,
        ...
        },
        {
          ...
          capacity: 200,
          thumbnailUrl:
            "https://images.unsplash.com/photo-1562771379-eafdca7a02f8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bXVheSUyMHRoYWl8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60",
          isFeatured: true,
        ...
        },
        {
          ...
          capacity: 150,
          thumbnailUrl:
            "https://images.unsplash.com/photo-1599058917765-a780eda07a3e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8bXVheSUyMHRoYWl8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60",
          isFeatured: true,
        ...
        },
        {
          ...
          capacity: 80,
          thumbnailUrl:
            "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8a2lja2JveGluZ3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60",
          isFeatured: true,
        ...
        },
        {
          ...
          capacity: 60,
          thumbnailUrl:
            "https://images.unsplash.com/photo-1549719386-74dfcbf7dbed?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym94aW5nfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60",
          isFeatured: true,
          types: ["vtype_boxing"],
        ...
        },
        {
          ...
          capacity: 120,
          thumbnailUrl:
            "https://images.unsplash.com/photo-1544117519-31a4a39cb2bc?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8dGhhaSUyMGJveGluZ3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60",
          isFeatured: true,
          types: ["vtype_muaythai"],
          primaryType: "vtype_muaythai",
        },
