  ...
  return (
    <main className="container mx-auto px-4 py-12">
      <div className="mx-auto max-w-md rounded-lg bg-white p-8 shadow-md">
        ...
        <h1 className="mb-6 text-center text-2xl font-bold">PayPal Checkout</h1>
        ...
        {error ? (
          <>
            ...
            <button
              onClick={() => router.back()}
              className="w-full rounded-md bg-red-600 px-4 py-3 font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
            >
              Return to Checkout
            </button>
          </>
