    ...
    <main className="container mx-auto px-4 py-16">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="prose max-w-none">
          <p className="mb-4">
            At ThaiBoxingHub, we are committed to protecting your privacy and
          ...
          <ul className="mb-4 list-disc pl-6">
            <li className="mb-2">
              Personal information (name, email address, phone number) when you
              create an account or make a booking
            </li>
            <li className="mb-2">
              Payment information when you purchase tickets (processed securely
              through our payment providers)
            </li>
            <li className="mb-2">
              Usage data and cookies to improve our website functionality and
              user experience
            </li>
            <li className="mb-2">
          ...
          <ul className="mb-4 list-disc pl-6">
            ...
            <li className="mb-2">
              Sending event updates and important notifications
            </li>
          ...
          <h2 className="mb-4 mt-8 text-2xl font-semibold">3. Data Security</h2>
          <p className="mb-4">
            We implement appropriate security measures to protect your personal
            information against unauthorized access, alteration, disclosure, or
            destruction. Your payment information is processed through secure
            payment gateways that comply with industry standards for data
            protection.
          </p>

          <h2 className="mb-4 mt-8 text-2xl font-semibold">4. Data Sharing</h2>
          ...
          <ul className="mb-4 list-disc pl-6">
            ...
            <li className="mb-2">
              Event organizers for event management purposes
            </li>
            <li className="mb-2">
          ...
          <h2 className="mb-4 mt-8 text-2xl font-semibold">6. Cookies</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            <br />
            <a
              href="mailto:privacy@thaiboxinghub.com"
