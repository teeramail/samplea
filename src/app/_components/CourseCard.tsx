...
type CourseItem = Awaited<
  ReturnType<typeof api.trainingCourse.list>
>["items"][number];
...
function CourseCard({ course }: { course: CourseItem }) {
  ...
  return (
    <Link
      ...
      className="block overflow-hidden rounded-lg shadow-lg transition-shadow duration-300 ease-in-out hover:shadow-xl"
    >
