          ...
          <div className="md:col-span-2">
            ...
            >
              ...
              <button
                ...
                className="rounded bg-red-600 px-6 py-2 font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:bg-gray-400"
              >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">
                    123 Boxing Lane, Bangkok 10110, Thailand
                  </p>
                </div>
                <div>
