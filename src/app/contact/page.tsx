          ...
          <div className="md:col-span-2">
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-lg p-6 shadow-md">
              ...
              <button
                ...
                className="px-6 py-2 bg-red-600 text-white font-medium rounded hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:bg-gray-400"
              >
            ...
            <div className="bg-white rounded-lg p-6 shadow-md mb-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">123 Boxing Lane, Bangkok 10110, Thailand</p>
                </div>
                <div>
                  <h3 className="font-medium text-gray-900">Email</h3>
                  <p className="text-gray-600">info@teeramuaythaione.com</p>
                </div>
                <div>
